...
class SyrupInformation extends StatefulWidget {
  ...
  SyrupInformation({Key? key, this.doc, this.mname
    /*required this.post*/
  })
      : super(key: key);

  @override
  State<SyrupInformation> createState() => _SyrupInformationState();
}

class _SyrupInformationState extends State<SyrupInformation> {
  @override
                            ...
                            Card(
                              ...
                              child: Column(
                                children: [
                                  ListTile(
                                    title: Text(
                                      postDetail[i]['syrupprice'], style: TextStyle(fontWeight: FontWeight.bold),),
                                    subtitle:  Text(
                                      postDetail[i]['syrupmg'],
