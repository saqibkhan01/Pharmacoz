...
class InjectionInformation extends StatefulWidget {
  ...
  InjectionInformation({Key? key, this.doc, this.mname
    /*required this.post*/
  })
      : super(key: key);

  @override
  State<InjectionInformation> createState() => _InjectionInformationState();
}

class _InjectionInformationState extends State<InjectionInformation> {
  @override
  Widget build(BuildContext context) {
    final user = FirebaseFirestore.instance
        ...
        .doc(widget.doc)
        .collection("admins")
        .where('injection', isEqualTo: true)
        .snapshots();
    return Scaffold(
      appBar: AppBar(
                            ...
                            Card(
                              ...
                              child: Column(
                                children: [
                                  ListTile(
                                    title: Text(
                                      postDetail[i]['injectionprice'], style: TextStyle(fontWeight: FontWeight.bold),),
                                    subtitle:  Text(
                                      postDetail[i]['injectionmg'],
